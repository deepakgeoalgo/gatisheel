                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <div class="controls">
                                                <label>Email</label>
                                                <input type="email" class="form-control" placeholder="Year" name="email" value="{{ $installations->user->email }}" required data-validation-required-message="This year field is required">
                                            </div>
                                        </div>                           
